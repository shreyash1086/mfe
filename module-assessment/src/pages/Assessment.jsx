  ...
  <div className="relative overflow-hidden">
    ...
    >
      ...
      <g clipPath="url(#lineClip)">
        ...
        >
          <path
            d="M7 7H17M7 10H17M7 13H17M7 16H17M7 19H17M7 22H17"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
          />
  ...
  const cards = [
    {
      ...
      description:
        "Design custom quizzes, coding labs, and technical exams with our intuitive builder.",
    ...
    },
    {
      ...
      description:
        "Access 500+ pre-built technical assessments for cloud, security, and devops.",
    ...
    },
    {
      ...
      description:
        "Detailed performance heatmaps, cohort benchmarking, and student skill profiles.",
    ...
    },
    {
      title: "SQL Databases",
      description:
        "Manage sandbox environments for SQL practical assessments and query challenges.",
    ...
    },
    {
      title: "MCQ Datasets",
      description:
        "Curate and version-control your question banks for automated randomized testing.",
  ...
  const filteredCards = cards
    .filter((card) => {
      if (userRole === "candidate" || userRole === "trainer") {
        return ["/assessment/assessments-list", "/assessment/reports"].includes(
          card.route,
        );
      }
      return true;
          ...
          <div className="flex items-center gap-4">
            ...
            {userRole === "admin" && (
              <button
                ...
                className="h-10 px-4 bg-blue-600 hover:bg-blue-700 text-white text-[11px] font-bold uppercase tracking-wider rounded-xl shadow-lg shadow-brand-accent/25 flex items-center gap-2 transition-all hover:scale-[1.02] active:scale-95"
              >
              ...
              <Link to={card.route} key={card.id} className="h-full w-full">
                <Card className="p-8 h-full">
                  <div className="relative z-10 flex flex-col h-full">
                    <div
                      className={`w-16 h-10 ${iconBg} rounded-full mb-8 flex items-center justify-center group-hover:scale-110 transition-all duration-500`}
                    >
                      <card.icon color={iconColor} />
                    </div>

                    <h3
                      className={`text-2xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight transition-colors ${hoverBorderColor || "group-hover:text-brand-accent"}`}
                    >
                      {card.title}
                    </h3>
