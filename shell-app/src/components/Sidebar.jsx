...
function Sidebar({ isOpen, onClose }) {
  ...
  const baseNavItems = [
    ...
    // { path: '/cloud-console', label: 'Kloud Console', icon: 'vpn_key', color: 'text-orange-500 dark:text-orange-400', accessKey: 'cloud_console_access' },
    {
      path: "/cloud-labs",
      label: "Kloud Labs",
      icon: "cloud",
  ...
  const adminTrainerItems = [
    ...
    // { path: '/code', label: 'Kode ENV', icon: 'terminal', color: 'text-red-500 dark:text-red-400', accessKey: 'kode_access' },
  ];
