...
function Sidebar({ isOpen, onClose }) {
  ...
  const adminTrainerItems = [
    ...
    { path: '/code-module', label: 'Kode ENV', icon: 'terminal', color: 'text-emerald-500 dark:text-emerald-400', accessKey: 'kode_access' },
  ];
  ...
  const candidateItems = [
    ...
    { path: '/code-module', label: 'Kode Module', icon: 'terminal', color: 'text-emerald-500 dark:text-emerald-400', accessKey: 'kode_access' },
  ];
